...
<head>
    ...
    <style>
        ...
        .content {
            ...
            position: absolute;
            top: 20px;
            /* Adjust this value to position the content from the top */
            left: 0;
            right: 0;
            text-align: center;
        }
...
<body class="antialiased">
    ...
    <div class="video-container">
        <video autoplay muted loop>
            <source src="{{ URL::asset('uploads/video4.mp4') }}" type="video/mp4">
                ...
                function e() {
                    if (w) {
                        ...
                        v.prepend($canvas),
                            ...
                            f();
                        for (
                            var b = Math.round((p.width * p.height) / d.density), c = 0; b > c; c++
                        ) {
                            var e = new l();
                ...
                function l() {
                    switch (
                        ...
                        default:
                            ...
                            (this.speed.x +=
                                this.speed.x > 0 ? d.minSpeedX : -d.minSpeedX);
                    }
                    switch (d.directionY) {
                        case "up":
                            this.speed.y = +(
                                -d.maxSpeedY +
                                Math.random() * d.maxSpeedY -
                                d.minSpeedY
                            ).toFixed(2);
                            break;
                        case "down":
                        ...
                        default:
                            ...
                            (this.speed.x +=
                                this.speed.y > 0 ? d.minSpeedY : -d.minSpeedY);
                    }
                }
                ...
                return (
                    ...
                    (l.prototype.updatePosition = function() {
                        if (d.parallax) {
                            ...
                            (this.parallaxTargX =
                                (pointerX - s / 2) / (d.parallaxMultiplier * this.layer)),
                            (this.parallaxOffsetX +=
                                (this.parallaxTargX - this.parallaxOffsetX) / 10),
                            (this.parallaxTargY =
                                (pointerY - t / 2) / (d.parallaxMultiplier * this.layer)),
                        ...
                        switch (d.directionX) {
                            ...
                            case "right":
                                this.position.x + this.speed.x + this.parallaxOffsetX >
                                    v.width() && (this.position.x = 0 - this.parallaxOffsetX);
                                break;
                            default:
                                (this.position.x + this.speed.x + this.parallaxOffsetX >
                                    v.width() ||
                        ...
                        switch (d.directionY) {
                            ...
                            case "down":
                                this.position.y + this.speed.y + this.parallaxOffsetY >
                                    v.height() && (this.position.y = 0 - this.parallaxOffsetY);
                                break;
                            default:
                                (this.position.y + this.speed.y + this.parallaxOffsetY >
                                    v.height() ||
